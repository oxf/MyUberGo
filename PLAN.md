...
- [ ] **CI**: add `observability` (and `contracts`, already missing from the matrix independent of this pass) to `.github/workflows/ci.yml`'s service matrix — tracked as the next step in this same pass, not yet done as of this bullet being written.
